...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <script src="./JS/ThemDeThi.js"></script>
  <script src="./JS/LoadMonHoc.js"></script>
												...
												<div class="tab-pane active" id="tab_1_1">
													<form role="form" action="#">
														...
														<div class="margin-top-10">
															<a href="" id="btnTaoDe" name="btnTaoDe"class="btn btn-primary a-btn-slide-text" style="background-color:rgb(83, 129, 204)"> Tạo đề </a> 
															<a href="" id="btnHuy" name="btnHuy" class="btn btn-primary a-btn-slide-text" style="background-color:rgb(83, 129, 204)"> Hủy </a>
														</div>
													</form>
												</div>
