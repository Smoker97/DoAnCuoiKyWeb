...
<meta name="viewport" content="width=device-width, initial-scale=1">
  ...
  <script src="./JS/LoadLopHoc.js"></script>
  <script src="./JS/taoLichThi.js"></script>
													...
													<form role="form">
														...
														<div class="margiv-top-10">
															<a href="" id="btnTaoLich" name="btnTaoLich"
																class="btn btn-primary a-btn-slide-text" style="background-color:rgb(83, 129, 204)">Tạo Lịch</a> <a href=""
																id="btn-Huy" name="btn-Huy" class="btn btn-primary a-btn-slide-text" style="background-color:rgb(83, 129, 204)">Hủy</a>
														</div>
													</form>
												</div>
