...
<head>
    <title>Cập Nhập Thông Tin Lớp Học</title>
    <meta charset="UTF-8">
...
<body>
    <div class="wrap">
        ...
        <br>   	
            ...
            <label style="text-decoration:underline; color:#0d875c;">SỬA THÔNG TIN LỚP HỌC:</label>
            <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-4">
                        <input type="text" id="CName" class="form-control" size="30" placeholder="Nhập lớp học">
                    </div>
                </div>
       ...
       <script src="./JS/CapNhapClass.js"></script>
